...
**(1b)** Examine Table 1. Describe what this table is showing the reader. After looking at this table, what variables would you tell the researchers they need to include in their multivariate regression as control variables? *(0.5 pts.)*

**(1c)** Examine Table 2. What is the average treatment effect of the "self" treatment? Show your calculation. Would you say this is a causal estimate -- why or why not? *(0.5 pts.)*

**(1d)** Examine Table 3. Interpret the fourth coefficient (middle left cell) in terms of its statistical and substantive significance using the substantive meanings of the IV and DV. How does this coefficient change if the authors include covariates in their model? What does this tell us about their research findings? Would you say this is a causal estimate -- why or why not? *(0.5 pts.)*
...
**(3a)** Descriptive statistics: Explore the bribery variable. What kind of variable is this? What is this variable's maximum and minimum? What is the mean level of corruption? What is the standard deviation? Create a density plot to show how this variable is distributed and substantively interpret what this plot tells you about how corruption is distributed across countries. *(1 pt.)*

**(3b)** You want to understand what predicts bribery across oil-rich countries. What is the difference of means in bribery across countries with and without a regulatory NOC? *(1 pt.)*
