...
The most important thing is that your mathematical notation is contained within a set of dollar signs. As you saw above, using two dollar signs on either end tabs down a line and centers the formula, while a single dollar sign will insert the formula in-line: $Y_i = \beta_0 + \beta_1 X_i + \epsilon_i$. You can hover your mouse over the equation to see how it will appear in your knitted file.
