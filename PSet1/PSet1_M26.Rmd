---
title: "Problem Set 1 (Due 26 June 2026, 5:00 pm)"
...
If you are looking at the HTML version of the problem set (`PSet1_M26.html`) that may have opened in your web browser, you are seeing the ouput produced by running the "script"" or code called in the file `PSet1_M26.Rmd`, also available on the course website. Go ahead and open the file called `PSet1_M26.Rmd`. If it does not open automatically within RStudio, you can open RStudio first and then use the File menu to open up `PSet1_M26.Rmd`. Once you open `PSet1_M26.Rmd`, you can continue reading the text easily in that file.
...
Please submit your problem set via Canvas. Submit both the `.Rmd` file, and the `.html` file it creates when you knit it. This assignment is due by 5pm on Friday, June 26, 2026. Please list any students you collaborated with. Please also disclose whether you employed generative AI to complete this assignment, and how you used it, in the space at the end of the problem set.
...
Q5. Load the data into `R`. The data are stored as an `.RData` file, so you can use the `load()` function to load it. What name is given to the dataset object in your environment?

**ANSWER: **

Q6. Check the dimensions of the data (i.e. the number of rows and columns). How many observations are there? How many variables are there?

**ANSWER: **

Q7. What are the names of the variables in the dataset?
...
Q9. Calculate the average of the human rights index across all points in the sample. What does this tell you about the prevalence of human rights protections? Make sure to explain what this value is communicating.

**ANSWER: **

Q10. Produce a simple scatterplot with average income (GDP per capita) on the horizontal axis and the human rights protections (Human Rights Index) on the vertical axis.

Q11. Make the plot again, but this time add a trend line (also known as a line of best fit or a regression line) using the `abline()` command.

Q12. What does this line tell you about the relationship between development and human rights?

**ANSWER: **

Q13. Is this a causal relationship? Explain why or why not.
