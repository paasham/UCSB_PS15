...
#### 2. Set your working directory and load your dataset
```{r}

```

#### 3. How many variables do you have? What are their names? What is your sample size?

```{r}

```

#### 4. Look at the codebook for your dataset. Using your knowledge of the subject, hypothesize a relationship between two of the variables. Which variable is your dependent variable? Independent variable?

#### 5. Find the mean, median, range, standard deviation, and variance for your independent variable and dependent variable. 
```{r}

```

#### 6. Look at the sampling distribution(histogram) of both your variables. 
...
#### 7. Create a frequency distribution for both of your variables.

```{r}

```

#### 8. Calculate the correlation and covariance between your independent and dependent variables. 
...
#### 9. Create a scatterplot with your independent variable on the X axis and your dependent variable on the Y axis. Add a regression line to your plot. 
...
#### 10. Write down the model of your regression. 


#### 11. Show the summary of your bivariate regression. Interpret the intercept and the coefficient for your indepedent variable. A one-unit change in your indepedent variable is associated with what change in your dependent variable?
...
* Is the relationship significant? ie interpret the p-value. What does the p-value mean in this context?

* What is your null hypothesis? Do you reject it?

* What is your alternative hypothesis? Does the data support it?

#### 12. Create a meaningful subset of your data. Run the same regression and see how/if results change. 
